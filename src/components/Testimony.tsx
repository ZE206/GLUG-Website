    ...
    <div className="testimonialsBlock flex justify-center">
      <div className="bg-[#191a23] rounded-[3rem] p-6 md:p-10 lg:mx-60 text-white w-[90vw] md:w-full overflow-hidden">
        ...
        <div className="arrowBar flex items-center gap-[15vw] md:gap-[25vw] mt-[1rem] md:px-10">
          ...
          <img src="public/Arrow.png" alt="left arrow" className="cursor-pointer rotate-180" onClick={onPrev} />
          <div className="starBar flex w-full">
            {Array.from({ length: currNo }, (_, i) => (
              <img src="public/WhiteStar.png" alt="star" key={i} className="mr-[1rem] cursor-pointer" />
            ))}
            <img src="public/BrightStar.png" alt="star" key={currNo} className="mr-[1rem] cursor-pointer" />
            {Array.from({ length: total - currNo - 1 }, (_, i) => (
              <img
                src="public/WhiteStar.png"
                alt="star"
                key={`star-${i + currNo + 1}`}
          ...
          <img src="public/Arrow.png" alt="right arrow" className="cursor-pointer" onClick={onNext} />
        </div>
      </div>
    </div>
  );
