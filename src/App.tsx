        ...
        <div className="w-full">
            <div className="titleBlock pt-8 md:pt-18 w-9/10 sm:w-88/100 mx-auto">
                ...
                <div className="body flex flex-col-reverse mt-5 mx-auto md:mt-0 md:gap-0 md:flex-row md:justify-between">
                    <div className="msg md:w-1/2 flex flex-col items-center md:items-start md:mt-[2%]">
                        <div
                            className="subtitle font-secondary text-white text-5xl md:text-5xl lg:text-[74px]
                        lg:leading-24 font-bold p-4 md:text-left text-center"
                        >
                            <h1>
                                Welcome to
                                <br /> GLUG NITC!
                        ...
                        <div className="subbody md:mt-2  lg:text-[22px] font-primary md:text-left text-center text-[rgba(170,170,170,0.666)] md:ml-4 w-9/10 ">
                            We’re the GNU/Linux Users Group of NIT Calicut. From
                            kernel to code, we dive deep into the world of FOSS,
                            create impactful projects, and push the boundaries
                            of what’s possible with linux and beyond.
                        </div>
                    </div>
            ...
            <div className="exploreBlock flex flex-col items-center p-5 md:p-10 gap-[5rem] mt-10 md:mt-0">
                <div className="title self-start mb-0">Explore</div>
                <div className="mainServicesBlock bg-custom_orange h-[30vh] md:h-[30vh] lg:h-[35vh] w-[80vw] lg:w-[50vw] rounded-2xl md:flex md:justify-between p-5 md:p-10 text-2xl">
                    ...
                    <img
                        src="/browser_click.png"
                        alt="image"
                        className="h-[20vh] hidden md:block"
                    />
                </div>
            </div>
                ...
                <div className="greyBox bg-gray-200 rounded-3xl p-7 md:p-5 md:pl-10 flex justify-between font-semibold w-[90vw] text-center md:text-left md:w-[75vw]">
                    <div className="textBox flex flex-col justify-around">
                        <div className="textContent text-2xl md:text-xl lg:text-3xl mb-6 md:mb-3">
                            Tired of your computer begging for updates
                            <br />
                            every five minutes and crashing like it’s 1999?
                            <br />
                            Maybe it’s time to try Linux—because wasting
                            <br />
                            your life waiting on Windows is so 2000s
                        </div>
                    ...
                    <div className="imageContainer">
                        <img
                            src="/weird_bob.png"
                            alt="Hey"
                            className="hidden md:block md:ml-10 md:mt-10 lg:ml-0 lg:mt-0 translate-y-[3.5rem]"
                        />
                    </div>
                </div>
            </div>
            ...
            <div className="testimonialsBlock flex flex-col p-15 items-center">
                <div className="title self-start">Testimonials</div>
                <UserTestimonials />
            </div>
